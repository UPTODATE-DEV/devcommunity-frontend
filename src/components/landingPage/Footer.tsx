        ...
        <Stack spacing={4}>
          ...
          <Grid container spacing={{ xs: 2, md: 6 }}>
            ...
            <Grid item xs={12} sm={6} lg={2.5}>
              <Stack>
                <Typography variant="h4" color="text.primary" fontSize={18} component="span" sx={{ py: 2 }}>
                  NAVIGATIONS
                </Typography>
                {navigations.map((el) => (
                  <Stack
          ...
          <Typography color="text.secondary" component="p" textAlign="center" sx={{ pt: 4 }}>
            &copy; Updev Community {new Date().getFullYear()}. All rights reserved. Designed by{" "}
            <Typography color="primary.main" component="a" href="https://uptodatedevelopers.com" target="_blank">
              Uptodate Developers.{" "}
            </Typography>
          </Typography>
        </Stack>
